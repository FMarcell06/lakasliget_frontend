...
const DEFAULT_EXTRA_FIELDS = {
  ...
  lift: "Nincs megadva",
  ceilingHeight: "",
  airConditioner: "Nincs megadva",
  furnished: "Nincs megadva",
  moveInDate: "",
  minRentTime: "",
  accessible: "Nincs megadva",
  bathroomWc: "",
  orientation: "",
  view: "",
  balconySize: "",
  gardenAccess: "Nincs megadva",
  attic: "Nincs megadva",
  equipped: "Nincs megadva",
  pets: "Nincs megadva",
  smoking: "Nincs megadva",
  parking: "",
  heating: "",
  insulation: "Nincs megadva",
  energyCert: "",
};
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const contactData = userDocSnap.exists()
        ? {
            contactName:
              userDocSnap.data().contactName || user.displayName || "",
      ...
      Object.keys(extraFields).forEach((key) => {
        finalExtraFields[key] =
          extraFields[key] === "" ? "Nincs megadva" : extraFields[key];
      });
      ...
      if (id) {
        ...
        await addHome(
          { ...apartmentData, thumbnail: finalThumbnail },
          newGalleryImages,
        );
      }
  ...
  return (
    <div className="property-form-container">
      ...
      <div className="form-header">
        <h1>
          <FaCloudUploadAlt />{" "}
          {id ? "Hirdetés szerkesztése" : "Ingatlan hirdetés feladása"}
        </h1>
      ...
      <form className="property-form-card" onSubmit={handleSubmit}>
        <div className="form-section">
          ...
          <div className="form-group">
            ...
            <input
              className="form-group-input-hirdetes"
              type="text"
              value={title}
              onChange={(e) => setTitle(e.target.value)}
              placeholder="pl. Modern garzon a Corvin negyedben"
              required
            />
          </div>
            ...
            <div className="amp-field-row">
              <div className="amp-address-display">
                ...
                {inputMode === "manual" ? (
                  ...
                  <span
                    className={`amp-address-text ${!address ? "amp-placeholder" : ""}`}
                  >
                    {reverseLoading
                      ? "Cím lekérése..."
                      : address || "Keress rá vagy kattints a térképre"}
                  </span>
                )}
              </div>
              ...
              <div className={`amp-map-panel ${isMapOpen ? "open" : ""}`}>
                ...
                {(suggestions.length > 0 || isLoadingSuggestions) && (
                  <ul className="amp-suggestions">
                    {isLoadingSuggestions && (
                      <li className="amp-suggestion-loading">Keresés...</li>
                    )}
                    {suggestions.map((s) => (
                      <li
                        key={s.place_id}
                        className="amp-suggestion-item"
                ...
                <div className="amp-map-container">
                  ...
                  <div className="amp-map-hint">
                    {reverseLoading
                      ? "⏳ Cím lekérése..."
                      : "📍 Kattints a térképre a helyszín kiválasztásához"}
                  </div>
                </div>

                <button
                  type="button"
                  className="amp-collapse-btn"
          ...
          <div className="property-grid-inputs">
            <div className="input-group">
              <label>
                <FaMoneyBillWave /> Havi bérleti díj (Ft)
              </label>
              <input
                type="number"
                value={price}
        ...
        <div className="form-section">
          ...
          <div className="property-grid-inputs">
            ...
            <div className="input-group">
              ...
              <input
                type="text"
                name="floor"
                value={extraFields.floor}
                onChange={handleExtraChange}
                placeholder="pl. 2. emelet"
              />
            </div>
            <div className="input-group">
              ...
              <input
                type="number"
                name="buildingLevels"
                value={extraFields.buildingLevels}
                onChange={handleExtraChange}
              />
            </div>
            <div className="input-group">
          ...
          <div className="property-grid-inputs">
            ...
            <div className="input-group">
              <label>
                <FaThermometerHalf /> Fűtés típusa
              </label>
              <input
                type="text"
                name="heating"
                value={extraFields.heating}
                onChange={handleExtraChange}
              />
            </div>
            <div className="input-group">
        ...
        <div className="form-section">
          ...
          <div className="property-grid-inputs">
            <div className="input-group">
              <label>
                <FaToilet /> Fürdő és WC
              </label>
              <input
                type="text"
                name="bathroomWc"
                value={extraFields.bathroomWc}
                onChange={handleExtraChange}
                placeholder="pl. Külön / Egyben"
              />
            </div>
            <div className="input-group">
              ...
              <input
                type="text"
                name="comfort"
                value={extraFields.comfort}
                onChange={handleExtraChange}
              />
            </div>
            <div className="input-group">
              <label>
                <FaAccessibleIcon /> Akadálymentes
              </label>
              <select
                name="accessible"
                value={extraFields.accessible}
                onChange={handleExtraChange}
              >
                <option value="Nincs megadva">Nincs megadva</option>
          ...
          <div className="property-grid-inputs">
            ...
            <div className="input-group">
              ...
              <select
                name="airConditioner"
                value={extraFields.airConditioner}
                onChange={handleExtraChange}
              >
                <option value="Nincs megadva">Nincs megadva</option>
                <option value="Van">Van</option>
        ...
        <div className="form-section">
          ...
          <div className="property-grid-inputs">
            <div className="input-group">
              <label>
                <FaCalendarAlt /> Beköltözhető ekkortól
              </label>
              <input
                type="date"
                name="moveInDate"
                value={extraFields.moveInDate}
                onChange={handleExtraChange}
              />
            </div>
            <div className="input-group">
            ...
            <div className="input-group">
              <label>
                <FaDog /> Kisállat hozható?
              </label>
              <select
                name="pets"
                value={extraFields.pets}
                onChange={handleExtraChange}
              >
                <option value="Nincs megadva">Nincs megadva</option>
                <option value="Igen">Igen</option>
            ...
            {id && home?.images?.length > 0 && (
              <>
                <p className="gallery-section-title">
                  Jelenlegi képek ({home.images.length} db):
                </p>
